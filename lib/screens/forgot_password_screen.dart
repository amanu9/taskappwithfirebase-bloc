          ...
          children: [
            ...
            ElevatedButton(
                ...
                await  _auth.sendPasswordResetEmail(email: _emailController.text.trim()).then((value){
                  ...
                  var snackbar=SnackBar(content: Text("chek your Email",style: TextStyle(color:Colors.white),
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(snackbar);
                   ...
                   var snackbar=SnackBar(content: Text("Error Occured",style: TextStyle(color:Colors.red),
